 ...
 */
public class VolumeActivity extends ConvertActivity
{	
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		sourceSpinner = populate(sourceSpinner, R.id.SpinnerSelectSourceAreaUnit, R.array.volume);		
		
		//Populates the desired spinner with area unit types
		desiredSpinner = populate(desiredSpinner, R.id.SpinnerSelectDesiredAreaUnit, R.array.volume);
		
		/*Sets up the listened for button clicks on the convert button. Also informs what type of calculation to perform
		E.g. area, length etc*/
		buttonListen(2);	//2 identifies volume
	}
}